namespace m.Migrations
{
    ...
    public partial class mig_employee : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Employees", "DoJA", c => c.DateTime(nullable: false));
            AddColumn("dbo.Employees", "DoI", c => c.DateTime(nullable: false));
            AddColumn("dbo.Employees", "DoSalary", c => c.DateTime(nullable: false));
            AddColumn("dbo.Employees", "DoL", c => c.DateTime(nullable: false));
            ...
            AddColumn("dbo.Employees", "restrict_pf_contri", c => c.Boolean(nullable: false));
            AddColumn("dbo.Employees", "zero_pension", c => c.Boolean(nullable: false));
            AddColumn("dbo.Employees", "zero_pt", c => c.Boolean(nullable: false));
